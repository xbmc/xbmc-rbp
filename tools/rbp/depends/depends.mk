export CFLAGS=-pipe -O3 -mcpu=arm1176jzf-s -mtune=arm1176jzf-s -mfloat-abi=softfp -mfpu=vfp -O3 -mabi=aapcs-linux -Wno-psabi -Wa,-mno-warn-deprecated
ifeq ($(USE_BUILDROOT),1)
	...
	export CFLAGS+=-isystem$(SYSROOT)/usr/include -isystem$(SYSROOT)/opt/vc/include -isystem$(PREFIX)/include -isystem$(PREFIX)/usr/include/mysql
